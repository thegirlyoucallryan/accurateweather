...
export const InformationPanel: React.FC = () => {
    ...
    const { isLoading, error } = useWeatherQuery(zip)
        ...
        <div className="bg-white rounded-xl p-4 w-full h-full flex flex-col justify-center place-self-center mt-[5%]">
            {isLoading ? (
                ...
                <div >
                        ...
                        <div className="w-full flex justify-between items-center">
                            <div className="flex items-center  gap-4">
                                ...
                                <div className="text-xl flex flex-row">
                                    <div className="font-bold lg:text-8xl md:text-7xl sm:text-5xl text-purple-900">{unit === 'F' ? current.tempF : current.tempC}°</div>
                    ...
                    {/* 5-day forecast */}
                    <div className="grid lg:grid-cols-5  md:grid-cols-2 sm:grid-cols-1 gap-3">
                        {forecast.map((f) => (
                            <div
                                key={f.date}
